...
GBLauncherLayer::GBLauncherLayer() : GB::Layer("GBLauncherLayer")
{
}

GBLauncherLayer::~GBLauncherLayer()
{
}

#if GB_IMGUI_ENABLED
void GBLauncherLayer::OnImGuiRender()
{
